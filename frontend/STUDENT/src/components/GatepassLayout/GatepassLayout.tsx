...
const tabs = [
  { key: "passes", label: "My Passes", route: "/passes", icon: "ticket", fallback: "P", size: 20 },
  { key: "apply", label: "Apply", route: "/apply", icon: "plus.circle", fallback: "+", size: 30 },
  { key: "profile", label: "Profile", route: "/profile", icon: "person", fallback: "P", size: 20 },
] as const;
    ...
    <View style={styles.page}>
      <View style={[styles.shell, { width: shellWidth }]}>
        <View style={[styles.topBar, { height: topHeight, paddingTop: insets.top }]}>
          <GatepassSymbol name="building.columns" fallback="" size={22} color="#000A1E" />
